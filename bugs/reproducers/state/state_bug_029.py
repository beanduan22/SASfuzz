...
def op():
    return tf.raw_ops.SparseSegmentSumGradV2(grad=tf.constant([1.0, 2.0, 3.0], tf.float64), indices=tf.constant([-2], tf.int64), segment_ids=tf.constant([-2], tf.int64), dense_output_dim0=tf.constant(2, tf.int32))
